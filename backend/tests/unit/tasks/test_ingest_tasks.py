...
class TestIngestPapersTask:
    ...
    def test_ingest_task_calls_service_with_correct_params(self, mock_ingest_response):
    ...
    def test_ingest_task_returns_serializable_result(self, mock_ingest_response):
    ...
    def test_ingest_task_commits_session_on_success(self, mock_ingest_response):
    ...
    def test_ingest_task_raises_exception_on_failure(self):
        ...
        mock_service = AsyncMock()
        mock_service.ingest_papers = AsyncMock(side_effect=Exception("Service failure"))
